...
module virtualNetwork_subnets 'subnet.bicep' = [for (subnet, index) in subnets: {
...
module virtualNetwork_peering_local 'virtual-network-peering.bicep' = [for (peering, index) in peerings: {
...
module virtualNetwork_peering_remote 'virtual-network-peering.bicep' = [for (peering, index) in peerings: if (contains(peering, 'remotePeeringEnabled') ? peering.remotePeeringEnabled == true : false) {

...
@description('The location to deploy the Redis cache service.')
...
@description('The name of the secret for The redis connection.')
...
@description('Optional, default is Basic. The type of Redis cache to deploy.')
...
resource redisKVSecret 'Microsoft.KeyVault/vaults/secrets@2023-02-01' = {
  parent: keyVault
  tags: tags
  name: redisConnectionSecretName
  properties: {

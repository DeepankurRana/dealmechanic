...
@description('Array to add multiple firewall rules')
param firewallRules array = [
  ...
  }
  {
    ...
    endIpAddress: '10.0.2.0'
  }
  {
    name: 'Internal IPs'
    startIpAddress: '10.0.1.0'
    endIpAddress: '10.0.1.0'
  }
]
...
resource fwRule 'Microsoft.Sql/servers/firewallRules@2023-02-01-preview' = [for rule in firewallRules: {
  parent: sqlServer
  name: rule.name
  properties: {
